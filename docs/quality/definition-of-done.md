...
| **3** | See **Phase 3 exit (2026-09-21)** in [`phase3-exit-criteria.md`](phase3-exit-criteria.md) — nine items: approved `StartRun`, `StopRun`/tree kill, hard budget stop, crash/`RecoveryRequired`, real run output, background hosting, Phase 3 adaptercontract UI-09+, trust-boundary disclosure (H101-115), startup guide | Was: one sentence in project plan; Creed carry-forwards wired at phase start |
